...
## this is just here to call the movie maker 'master' routine
def movie_maker_call():
    snapshot_dir='/Users/phopkins/Downloads/sbcn/snapshots'
    output_dir='/Users/phopkins/Downloads/sbcn/frames'
    cosmo=0.
    size=60.
    type_to_make='star'
    # frame range~1423-1965, snap~57-75
    movie_maker(xmax_of_box=size,snapdir=snapshot_dir,outputdir_master=output_dir,\
        ...
        #frames_per_gyr=800.,\
        #i_snap_min=57,i_snap_max=75,skip_bh=1,center_on_com=1,\
        frames_per_gyr=100.,\
        i_snap_min=60,i_snap_max=62,skip_bh=1,center_on_com=1,\
        theta_0=90.,phi_0=270.,add_extension='_p270_fpg800_500pix_interp_all',\
        camera_opening_angle=74.,\
        pixels=500,z_to_add=0.02,\
        use_old_extinction_routine=0)
        #frame_min=1420,frame_max=1519)
...
def test_im():
    ...
    out0,out1 = imaker.image_maker(sdir,snum,\
        snapdir_master=smaster,outdir_master='./',\
        cosmo=1,xrange=np.array([-1.,1.])*x00,\
