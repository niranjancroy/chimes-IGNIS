...
// rewrite input so this can be more easily wrapped to python, not IDL //
//int main(int argc, void *argv[])
int attenuate(int N_nu, double* nu_vec, int N_NH, double* NH_vec, double* metal_vec, int dust_key, double* atten_vec)
{
	/*
  	if (argc < 5) {
	...
	*/
	double nu,NH,metallicity_over_solar;
	int i_nu,i_NH;
