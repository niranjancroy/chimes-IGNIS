...
/* 
	...
	Example use : 
        compile       ::    > gcc agn_spectrum.c -o agn_spec
		 (if that doesn't work, try > gcc agn_spectrum.c -o agn_spec -lm
		   (thanks to Kirk Korista and Gordon Richards))
	...
	This code should be considered in the public domain -- feel free to 
	  use and modify it as you please. Use is entirely at your own risk, of course!
	  We ask only that, if it is of use to you, you acknowledge the source of 
	  the code by referencing Hopkins, Richards, & Hernquist (2006) 
	  as is appropriate. Cheers!
