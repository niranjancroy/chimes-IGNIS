...
struct globalVariables
{
  ...
  void *hybrid_data;                           /*!< Structure containing extra data for the hybrid cooling function. */
  ChimesFloat (*hybrid_cooling_fn)(struct gasVariables *myGasVars, struct globalVariables *myGlobalVars); /*!< Hybrid cooling function. */
...
ChimesFloat chimes_cooling_rate_external(struct gasVariables *myGasVars, struct globalVariables *myGlobalVars, int mode); 
