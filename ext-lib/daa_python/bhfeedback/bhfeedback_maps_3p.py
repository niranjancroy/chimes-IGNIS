...
#>>> import sys
#>>> sys.argv = ['bhfeedback_maps_3p.py', 'h113_HR_sn153/kick_s8e1v4p1', 0, 10 ]
#>>> execfile('bhfeedback_maps_3p.py')

# python bhfeedback_maps_3p.py  h113_HR_sn153/kick_s8e1v4p1  0  200  > log/map3p_kick_s8e1v4p1.log 2>&1 &
...
for snapnum in range(snap_ini,snap_end,1):
 ...
 outfile = outdir + '/map3p_%03d.png' % snapnum
