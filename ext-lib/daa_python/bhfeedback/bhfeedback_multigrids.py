...
#>>> import sys
#>>> sys.argv = ['bhfeedback_multigrids.py', 'h113_HR_sn153/kick_s8e1v4p1', 0, 10 ]
#>>> execfile('bhfeedback_multigrids.py')

# python bhfeedback_multigrids.py  h113_HR_sn153/kick_s8e1v4p1  snap_ini snap_end > log/grid_kick_s8e1v4p1.log 2>&1 &
...
if narg == 4:
  ...
  print 'syntax: python bhfeedback_multigrids.py sname snap_ini snap_end'
  sys.exit()
...
#for snapnum in [0,1]:
  ...
  if ind_snap.size != 1:
    ...
    continue
  ind_snap = ind_snap[0]
  cen_pos = bhdata['cum']['COMstar_pos'][ind_snap,ind_Rcm,:] + bhdata['bh']['pos'][ind_snap,:]
