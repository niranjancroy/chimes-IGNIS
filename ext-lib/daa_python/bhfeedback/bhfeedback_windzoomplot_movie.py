#>>> execfile('bhfeedback_windzoomplot_movie.py')

# python bhfeedback_windzoomplot_movie.py /simons/scratch/dangles/FIRE/bhfeedback/  h113_HR_sn152/spawn_res251_s9e1v30f05_w10dt100m1000_TshVsh  snap_ini snap_end > log/windzoomplot.log 2>&1 &
...
if narg == 5:
  ...
  print 'syntax: python bhfeedback_windzoomplot_movie.py basedir sname snap_ini snap_end'
  sys.exit()
...
for snapnum in range(snap_ini,snap_end,1):
 ...
 for i, dx in enumerate([ 100, 10, 1 ]):
   ...
   gridDone = bhlib.make_windgrid( simdir, snapnum, gridfile, dx=dx, rotmatrix=rotmatrix, center='BH', m_wind=3000., DesNgb=64, npix=512, SkipIfDone=SkipIfDone, P=P )
 ...
 figname = 'windzoomplot_%04d.png' % snapnum
 print '\n', figname
 fxsz = 10
 xyrat = 2./3.
 fysz = fxsz * xyrat
 ...
 fig.savefig( outdir + '/' + figname, dpi=300 )
 plt.close()
 sys.stdout.flush()
